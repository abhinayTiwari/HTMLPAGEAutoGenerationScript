...
const targetlocationFolder = 'C:\\xampp\\htdocs\\rise2019dev\\';
const excelfilepath = 'C:\\Users\\UM127517\\Downloads\\Master Contact List.xlsx';// needs to change
...
const template = fs.readFileSync('C:\\Users\\UM127517\\Documents\\rise-session-template.html').toString();//needs to change
const speaker_template = fs.readFileSync('C:\\Users\\UM127517\\Documents\\speaker_template.html').toString();// needs to change
const rise_speaker_template = fs.readFileSync('C:\\Users\\UM127517\\Documents\\rise-speakers-template.html').toString();//needs to change
...
function createAgendaPages(Sessions)
{
    ...
    {
        let agenda_template = fs.readFileSync('C:\\Users\\UM127517\\Documents\\agenda-day'+ day+'-template.html').toString();
